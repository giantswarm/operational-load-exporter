"""app-test-suite smoke for the operational-load-exporter chart.
...
namespace = os.environ.get("ATS_RELEASE_NAMESPACE", "operational-load-exporter")
deployments = ["operational-load-exporter"]
timeout = 120
